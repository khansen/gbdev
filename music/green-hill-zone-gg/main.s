...
.sdsctag 1.0, "Green Hill Zone remix", "Original music Masato Nakamura", "@notube4me"
.COMPUTESMSCHECKSUM
...
Begin:
    ...
    call StartSong
    ld a, $ff
    out ($06), a ; all channels on, left and right
    ld [shadowChannelPanningReg], a
...
@skip:
    ...
    ret
@startY:
.db 114, 77, 35, 39, 48, 22, 19, 1, 82, 29, 65, 37, 87, 121, 24, 73
.db 49, 107, 7, 96, 83, 91, 110, 37, 54, 26, 105, 41, 123, 1, 49, 64
.db 29, 31, 34, 113, 96, 21, 79, 36, 16, 0, 119, 83, 81, 88, 26, 112
.db 85, 18, 93, 54, 22, 116, 2, 100, 47, 80, 15, 66, 58, 103, 53, 34
.db 92, 116, 101, 123, 70, 50, 47, 1, 83, 87, 74, 3, 111, 53, 76, 41
.db 93, 99, 0, 35, 24, 8, 103, 83, 37, 118, 20, 33, 41, 54, 65, 89
.db 18, 44, 109, 97, 56, 37, 75, 58, 70, 72, 23, 83, 113, 33, 107, 117
.db 115, 101, 122, 18, 50, 21, 81, 126, 26, 111, 35, 64, 108, 1, 83, 101
.db 17, 23, 44, 104, 46, 75, 93, 89, 36, 54, 70, 67, 62, 39, 118, 73
.db 50, 64, 60, 37, 2, 0, 7, 88, 29, 91, 55, 11, 125, 122, 110, 116
.db 80, 47, 15, 62, 9, 43, 107, 71, 105, 27, 45, 94, 112, 17, 110, 9
.db 84, 39, 119, 51, 71, 79, 31, 13, 67, 108, 29, 96, 19, 88, 74, 86
.db 9, 115, 104, 90, 16, 14, 93, 70, 59, 48, 6, 26, 38, 103, 82, 87
.db 45, 123, 92, 126, 85, 76, 59, 54, 62, 121, 65, 5, 82, 50, 104, 110
.db 34, 8, 86, 59, 95, 26, 98, 42, 13, 75, 102, 55, 63, 28, 41, 124
.db 69, 99, 19, 91, 118, 38, 107, 23, 72, 111, 84, 44, 20, 61, 100, 27
...
OBJTiles:
.incbin "heart.bin" ; $00 - 16 tiles
OBJTilesEnd:

TilemapData:
.db $39, $50, 30
.dw CHAR_G, CHAR_r, CHAR_e, CHAR_e, CHAR_n, CHAR_SPACE, CHAR_H, CHAR_i, CHAR_l, CHAR_l, CHAR_SPACE, CHAR_Z, CHAR_o, CHAR_n, CHAR_e
.db $3A, $0E, 34
...
.db $3A, $90, 30
.dw CHAR_M, CHAR_a, CHAR_s, CHAR_a, CHAR_t, CHAR_o, CHAR_SPACE, CHAR_N, CHAR_a, CHAR_k, CHAR_a, CHAR_m, CHAR_u, CHAR_r, CHAR_a
.db $3B, $52, 20
...
.dw $3A, $3C, $3F, $3F, $3D
.db $3A, $80, 12
.dw $3E, $3F, $3F, $3C, $3B, $3C
.db $3A, $F6, 10
.dw $40, $41, $3E, $3D, $3E
.db $3A, $C0, 12
.dw $3F, $3E, $42, $40, $41, $42
.db $3B, $3A, 6
.dw $40, $41, $42
.db $3B, $00, 4
.dw $40, $42
...
.dw $3A, $3B, $3C
.db $3C, $02, 12
.dw $3A, $3E, $3F, $3F, $3C, $3C
.db $3C, $40, 14
.dw $3A, $3E, $3F, $3D, $3E, $3E, $42
.db $3C, $80, 12
.dw $40, $41, $3E, $3F, $41, $42
.db $3C, $C4, 4
.dw $41, $42
; cloud 3
.db $39, $02, 8
