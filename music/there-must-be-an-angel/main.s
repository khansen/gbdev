...
hBigHeartPosXFrac: db
hBigHeartPosXInt: db
hBigHeartPosYFrac: db
hBigHeartPosYInt: db
hBigHeartSpeedXFrac: db
hBigHeartSpeedXInt: db
hBigHeartSpeedYFrac: db
hBigHeartSpeedYInt: db
hBigHeartAccelXFrac: db
hBigHeartAccelXInt: db
hBigHeartAccelYFrac: db
hBigHeartAccelYInt: db
...
InitializeBigHeart:
    ld a, 0
    ldh [hBigHeartPosXFrac], a
    ldh [hBigHeartPosYFrac], a
    ldh [hBigHeartSpeedXFrac], a
    ldh [hBigHeartSpeedXInt], a
    ldh [hBigHeartSpeedYFrac], a
    ldh [hBigHeartSpeedYInt], a
    ldh [hBigHeartAccelXFrac], a
    ldh [hBigHeartAccelYFrac], a
    ld a, 160/2
    ldh [hBigHeartPosXInt], a
    ld a, 144/2
    ldh [hBigHeartPosYInt], a
    ld a, $0a
    ldh [hBigHeartAccelXFrac], a
    ld a, $04
    ldh [hBigHeartAccelYFrac], a
...
UpdateBigHeart:
    ...
    xor a, $ff
    adc a, 0
    ldh [hBigHeartAccelXInt], a
    jr .checkVerticalCollision
    .checkLeftCollision:
    cp a, 60
    jr c, .invertXAccel
    .checkVerticalCollision:
    ldh a, [hBigHeartAccelYInt]
    bit 7, a
    ldh a, [hBigHeartPosYInt]
    ...
    ldh a, [hBigHeartAccelXFrac]
    ld b, a
    ldh a, [hBigHeartSpeedXFrac]
    add a, b
    ldh [hBigHeartSpeedXFrac], a
    ldh a, [hBigHeartAccelXInt]
    ld b, a
    ldh a, [hBigHeartSpeedXInt]
    adc a, b
    ldh [hBigHeartSpeedXInt], a
    bit 7, a
    jr nz, .clipNegativeXSpeed
    ...
    ldh a, [hBigHeartAccelYFrac]
    ld b, a
    ldh a, [hBigHeartSpeedYFrac]
    add a, b
    ldh [hBigHeartSpeedYFrac], a
    ldh a, [hBigHeartAccelYInt]
    ld b, a
    ldh a, [hBigHeartSpeedYInt]
    adc a, b
    ldh [hBigHeartSpeedYInt], a
    bit 7, a
    jr nz, .clipNegativeYSpeed
...
incbin "bigheart.bin" ; $06 - 4 tiles
incbin "heart.bin" ; $0A - 2 tiles
OBJTilesEnd:
...
db $98, $23, 13, "There Must Be"
db $98, $46, 8, "An Angel"
db $98, $83, 13, "(Playing With"
db $98, $A4, 12, "Pit's Heart)"
