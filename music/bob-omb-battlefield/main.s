...
UpdateObject:
    ...
    bit 0, a ; type (0=bobomb2, 1=bobomb3)
    jp z, UpdateBobOmb2
    jp UpdateBobOmb3
...
.skip:
    ...
    and a, 4
    jr nz, .drawFrame1
    jp DrawBobOmb3Frame0
.drawFrame1:
    jp DrawBobOmb3Frame1
...
.skip:
    ...
    and a, 4
    jr nz, .drawFrame1
    jp DrawBobOmb2Frame0
.drawFrame1:
    jp DrawBobOmb2Frame1
...
OBJTiles:
incbin "bobomb2.bin" ; 8 tiles
incbin "bobomb3.bin" ; 8 tiles
OBJTilesEnd:
...
db $98, $65, 10, "Main Theme"
db $98, $A5, 8, "(Bob-omb"
db $98, $C4, 12, "Battlefield)"
db $99, $04, 11, "Original by"
db $99, $45, 10, "Koji Kondo"
...
db $99, $C4, 11, $02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02
db 0
